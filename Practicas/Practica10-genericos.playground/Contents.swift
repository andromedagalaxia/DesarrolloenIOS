...
let resultado2 = suma2(a: 42.5, b: 99.5)
...
print (sumaGenerica(a: 42.5, b: 99.5))
print (sumaGenerica(a: Double.pi, b: 99))
...
if encontrado   != nil {
    print("Se encontró en la posiciòn: ")
    print(encontrado!)
}else{
...
let objetoEnfermo:EnfermoGrave = EnfermoGrave(nombre: "Juan Lopez",padecimiento: "Diabetes"
, nivelDolor: 3)
